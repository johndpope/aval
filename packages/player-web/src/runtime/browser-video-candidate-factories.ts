...
export class BrowserVideoCandidateWorkerFactory
  implements VideoCandidateWorkerFactory {
  readonly #hub: BrowserVideoCandidateHub;
  readonly #options: CreateDecoderWorkerClientOptions;
  readonly #createPort: BrowserVideoCandidateTestDependencies["createWorkerPort"];
  ...
  public constructor(options: {
    ...
    readonly createWorkerPort?: BrowserVideoCandidateTestDependencies["createWorkerPort"];
  }) {
...
export class BrowserVideoCandidateRendererFactory
  implements VideoCandidateRendererFactory {
  readonly #canvas: HTMLCanvasElement;
  readonly #hub: BrowserVideoCandidateHub;
  readonly #createBackend: NonNullable<
    BrowserVideoCandidateTestDependencies["createFrameBackend"]
  >;
  ...
  public constructor(options: {
    ...
    readonly presentationPlanes?:
      BrowserVideoCandidateCompositionOptions["presentationPlanes"];
    readonly createFrameBackend?: BrowserVideoCandidateTestDependencies["createFrameBackend"];
  }) {
...
class TrackedCandidateWorker
  implements VideoCandidateWorker, BrowserTrackedWorker {
  ...
  public snapshot(): Readonly<BrowserVideoWorkerSnapshot> {
...
class BrowserRendererReservation
  implements VideoCandidateRendererReservation {
...
class TrackedRenderer implements BrowserTrackedRenderer {
  ...
  public snapshot(): Readonly<BrowserVideoRendererSnapshot> {
    return Object.freeze({
