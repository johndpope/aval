import { inspectH265AnnexBRendition } from "@pixel-point/aval-format";
...
export const H265_BITSTREAM_ADAPTER: VideoBitstreamAdapter = Object.freeze({
  inspect(input: Readonly<CodecAdapterInput>) {
    ...
    return Object.freeze({
      ...
      bitDepth: inspection.parameterSet.bitDepth,
