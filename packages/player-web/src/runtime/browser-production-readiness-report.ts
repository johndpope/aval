...
import type {
  BrowserReadinessCleanup,
  BrowserReadinessRouteRun
...
export interface BrowserProductionScenarioEvidence {
  ...
  readonly cleanup: Readonly<BrowserReadinessCleanup>;
}
...
export interface BrowserProductionReadinessReport {
  ...
  readonly cleanup: readonly Readonly<BrowserReadinessCleanup>[];
...
export function createProductionRouteEvidence(input: {
  ...
  readonly run: Readonly<BrowserReadinessRouteRun>;
...
function verifyTransitionSequence(
  ...
  run: Readonly<BrowserReadinessRouteRun>
): boolean {
