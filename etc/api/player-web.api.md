## API Report File for "@rendered-motion/player-web"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import type { AccessUnitRecord } from '@rendered-motion/format';
import { AvcConstrainedBaselineProfile } from '@rendered-motion/format';
import { AvcRenditionGeometry } from '@rendered-motion/format';
import { AvcRenditionInspection } from '@rendered-motion/format';
import { BindingSourceV01 } from '@rendered-motion/format';
import { BindingV01 } from '@rendered-motion/format';
import type { ByteRange } from '@rendered-motion/format';
import { CanvasV01 } from '@rendered-motion/format';
import { CompiledManifestV01 } from '@rendered-motion/format';
import { EdgeV01 } from '@rendered-motion/format';
import { FormatHeader } from '@rendered-motion/format';
import { GraphBodyDefinition } from '@rendered-motion/graph';
import { GraphEdgeDefinition } from '@rendered-motion/graph';
import type { GraphPresentation } from '@rendered-motion/graph';
import type { GraphSettlementError } from '@rendered-motion/graph';
import { GraphStartPolicy } from '@rendered-motion/graph';
import type { GraphStateDefinition } from '@rendered-motion/graph';
import { IDENTIFIER_PATTERN } from '@rendered-motion/format';
import type { MotionGraphEffect } from '@rendered-motion/graph';
import type { MotionGraphOperation } from '@rendered-motion/graph';
import type { MotionGraphReadiness } from '@rendered-motion/graph';
import type { MotionGraphResult } from '@rendered-motion/graph';
import type { MotionGraphSnapshot } from '@rendered-motion/graph';
import type { MotionGraphTickOptions } from '@rendered-motion/graph';
import { ParsedFrontIndex } from '@rendered-motion/format';
import { PngDecodePlan } from '@rendered-motion/format';
import { PngRgbaDecodeResult } from '@rendered-motion/format';
import type { PortV01 } from '@rendered-motion/format';
import { RenditionV01 } from '@rendered-motion/format';
import type { ResidencyEndpointV01 } from '@rendered-motion/format';
import { StateV01 } from '@rendered-motion/format';
import type { StaticBlobRange } from '@rendered-motion/format';
import type { StaticFrameV01 } from '@rendered-motion/format';
import type { UnitBlobRange } from '@rendered-motion/format';
import { UnitV01 } from '@rendered-motion/format';
import { ValidatedAssetLayout } from '@rendered-motion/format';
import type { ValidatedMotionGraph } from '@rendered-motion/graph';
import { ValidatedStaticPngProfile } from '@rendered-motion/format';
...
// @public
export function asStaticSurfaceCatalog(catalog: RuntimeAssetCatalog): StaticSurfaceCatalogView;
...
export interface BrowserPngNativeInflater {
    // (undocumented)
    inflate(zlib: Uint8Array, expectedOutputLength: number, signal: AbortSignal): Promise<Uint8Array>;
    // (undocumented)
...
export class BrowserPresentationPlanes implements RuntimeCanvasResourceHost {
    ...
    // (undocumented)
    readonly staticPlane: BrowserStaticCanvasPlane;
}
...
// @public
export class BrowserStaticCanvasPlane implements StaticPresentationPlane<BrowserDecodedStaticSurface> {
    constructor(canvas: HTMLCanvasElement, setStaticVisible: (visible: boolean) => void);
    // (undocumented)
    coverStatic(): void;
    // (undocumented)
    dispose(): void;
    // (undocumented)
    present(surface: BrowserDecodedStaticSurface, width: number, height: number, options?: {
...
// @public (undocumented)
export type BrowserStaticDecoderResourceCategory = "png-copy" | "png-zlib" | "png-scratch";

// @public (undocumented)
export interface BrowserStaticDecoderResourceHost {
    // (undocumented)
    reserve(category: BrowserStaticDecoderResourceCategory, byteLength: number): BrowserStaticDecoderResourceLease | PromiseLike<BrowserStaticDecoderResourceLease>;
}
...
// @public
export class BrowserStaticSurfaceDecoder implements StaticSurfaceDecoder<BrowserDecodedStaticSurface> {
    // Warning: (ae-forgotten-export) The symbol "LeasedStaticPngSource" needs to be exported by the entry point index.d.ts
    //
    // @internal
    [LEASED_STATIC_PNG_DECODER](source: Readonly<LeasedStaticPngSource>, options: Readonly<StaticSurfaceDecodeOptions>): Promise<BrowserDecodedStaticSurface> | null;
    constructor(options?: Readonly<BrowserStaticSurfaceDecoderOptions>);
    // (undocumented)
    decode(png: Uint8Array, options: StaticSurfaceDecodeOptions): Promise<BrowserDecodedStaticSurface>;
    // (undocumented)
    snapshot(): Readonly<BrowserStaticSurfaceDecoderSnapshot>;
}

// @public (undocumented)
export interface BrowserStaticSurfaceDecoderOptions {
    // (undocumented)
    readonly createBitmap?: (rgba: Uint8Array, width: number, height: number) => Promise<ImageBitmap>;
...
// Warning: (ae-forgotten-export) The symbol "StaticSurfaceDecodeSnapshot" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
export interface BrowserStaticSurfaceDecoderSnapshot extends StaticSurfaceDecodeSnapshot {
    // (undocumented)
...
// @public
export function createBrowserPngNativeInflater(factory?: BrowserDecompressionStreamFactory): Readonly<BrowserPngNativeInflater>;
...
// @public
export function createStaticRuntimeResourcePlan(input: Readonly<StaticRuntimeResourcePlanInput>): Readonly<StaticRuntimeResourcePlan>;
...
// @public (undocumented)
export const MAX_PRESENTATION_BACKING_DIMENSION: 2048;
...
export interface PlayerWebRuntimeParticipant {
    ...
    // (undocumented)
    registerStaticSurfaceReclaimer(store: PlayerWebStaticSurfaceReclaimer): () => void;
    // (undocumented)
...
// @public (undocumented)
export const RUNTIME_BYTE_CATEGORIES: readonly ["asset-metadata", "asset-full", "response-body", "quarantine", "blob-assembly", "verified-unit", "verified-static", "worker-transfer", "decoder-output", "persistent-animation", "streaming-texture", "frame-staging", "png-copy", "png-zlib", "png-scratch", "decoded-static-cache", "current-static-surface", "incoming-static-surface", "animated-canvas-backing", "static-canvas-backing"];
...
export class RuntimeAssetCatalog {
    ...
    copyStaticPng(staticFrame: string): Uint8Array<ArrayBuffer>;
    // (undocumented)
    dispose(): void;
    // (undocumented)
    get disposed(): boolean;
    ...
    // (undocumented)
    readonly staticFrames: RuntimeCatalogIdIndex<RuntimeCatalogStaticFrame>;
    // (undocumented)
...
export interface RuntimeAssetSession {
    ...
    readonly disposed: boolean;
    // (undocumented)
    ensureAllStatics(options?: Readonly<RuntimeAssetEnsureOptions>): Promise<readonly Readonly<VerifiedBlobHandle>[]>;
    ...
    //
    // (undocumented)
    ensureStatic(staticFrame: string, options?: Readonly<RuntimeAssetEnsureOptions>): Promise<Readonly<VerifiedBlobHandle>>;
    // (undocumented)
...
// @public (undocumented)
export type RuntimeReclamationReason = "decoded-static" | "abandoned-animation" | "hidden-animation" | "optional-cache" | "requester-fallback" | "policy-reduction" | "participant-disposal";
...
// @public (undocumented)
export interface RuntimeResourceCatalogView extends RuntimeStaticResourceCatalogView {
    // (undocumented)
...
// @public (undocumented)
export interface RuntimeResourcePlan extends Omit<StaticRuntimeResourcePlan, "allocationSnapshot"> {
    // (undocumented)
...
// @public (undocumented)
export type RuntimeStaticPngValidator = (input: Readonly<RuntimeStaticPngValidationInput>) => Readonly<ValidatedStaticPngProfile>;
...
// @public (undocumented)
export const STATIC_REASONS: readonly ["reduced-motion", "no-avc-rendition", "worker-unavailable", "renderer-unavailable", "codec-unsupported", "resource-budget", "readiness-failed", "preparation-timeout", "animation-failure", "visibility-suspended", "decoder-queued"];

// @public (undocumented)
export type StaticPngInflatePath = "native" | "pure";

// @public
export interface StaticPresentationPlane<TSurface extends DecodedStaticSurface = DecodedStaticSurface> {
    // (undocumented)
    coverStatic(): void;
    // (undocumented)
    dispose?(): void;
    // (undocumented)
    present(surface: TSurface, width: number, height: number, options?: {
        readonly cover?: boolean;
    }): void;
    // (undocumented)
    revealAnimated(): void;
...
// @public (undocumented)
export interface StaticSurfaceDecoder<TSurface extends DecodedStaticSurface = DecodedStaticSurface> {
    // (undocumented)
    decode(png: Uint8Array, options: StaticSurfaceDecodeOptions): Promise<TSurface>;
    // (undocumented)
...
// @public (undocumented)
export class StaticSurfaceStore<TSurface extends DecodedStaticSurface = DecodedStaticSurface> {
    constructor(catalog: StaticSurfaceCatalogView, decoder: StaticSurfaceDecoder<TSurface>, plane: StaticPresentationPlane<TSurface>, options?: Readonly<StaticSurfaceStoreOptions>);
    coverCurrent(): void;
    // (undocumented)
    currentState(): string | null;
    // (undocumented)
    ...
    // Warning: (ae-forgotten-export) The symbol "StaticSurfaceEviction" needs to be exported by the entry point index.d.ts
    reclaimOldest(): Readonly<StaticSurfaceEviction> | null;
    // (undocumented)
    revealAnimated(): void;
    // (undocumented)
    settled(): Promise<void>;
    // (undocumented)
    snapshot(): Readonly<StaticSurfaceStoreSnapshot>;
    validateAll(options?: {
        readonly signal?: AbortSignal;
...
export interface StaticSurfaceStoreResourceHost {
    ...
    reserveDecodedSurface(input: Readonly<{
        ...
        byteLength: number;
        role: "incoming";
    }>): StaticSurfaceStoreResourceLease | PromiseLike<StaticSurfaceStoreResourceLease>;
}

// Warning: (ae-forgotten-export) The symbol "StaticSurfaceCacheLease" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
export interface StaticSurfaceStoreResourceLease extends StaticSurfaceCacheLease {
    // (undocumented)
...
export interface StaticSurfaceStoreSnapshot {
    // Warning: (ae-forgotten-export) The symbol "StaticSurfaceCacheSnapshot" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
// @public (undocumented)
export type StaticSurfaceStoreSurfaceRole = "current" | "incoming" | "optional";
