/// Bounded MSB-first reader for VP9 uncompressed headers.
///
/// Dart port of `packages/format/src/vp9/bit-reader.ts`.
library;
...
/// Bounded MSB-first reader for VP9 uncompressed headers.
class Vp9BitReader {
  Vp9BitReader(this._bytes, this._path);
  ...
  int readByte(String label) => readBits(8, label);
